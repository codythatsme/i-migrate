...
import { AlertCircle, ArrowRight, Circle, Loader2 } from "lucide-react";
        ...
        <div className="flex flex-col gap-4 px-4">
          ...
          <div className="flex items-center gap-2 p-3 bg-muted/30 rounded-lg">
            ...
            <div className="flex flex-col flex-1 min-w-0 text-right">
              ...
              <span className="font-medium text-sm truncate">{runningJob.destEnvironmentName}</span>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono">
                  {runningJob.processedRows.toLocaleString()} /{" "}
                  {runningJob.totalRows.toLocaleString()} rows
                </span>
              </div>
              ...
              <div className="flex justify-between text-sm">
                ...
                {rate && <span className="text-muted-foreground font-mono self-end">{rate}</span>}
              </div>
            </div>
          )}
          ...
          {hasFailed && (
            <div className="flex items-center gap-2 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
              ...
              <span className="text-sm text-amber-600">
                {runningJob.failedRowCount} row{runningJob.failedRowCount > 1 ? "s" : ""} failed
